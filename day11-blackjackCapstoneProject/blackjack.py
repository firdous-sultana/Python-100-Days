...
def calculate_score(cards):
    """Take the list of cards and return the score from the cards"""
...
while not is_game_over:
    ...
    print("Your cards: {}, Your current score: {} ".format(user_cards, user_score))
...
print(logo)
print("Your final hand is {}, final score: {}".format(user_cards, user_score))
print("Computer's final hand is {}, final score: {}".format(computer_cards, computer_score))
